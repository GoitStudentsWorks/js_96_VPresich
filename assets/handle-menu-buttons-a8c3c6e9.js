var T=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var B=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),R=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},D=(e,t,s,a)=>(T(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s);var d=(e,t,s)=>(T(e,t,"access private method"),s);import{i as H}from"./vendor-32231325.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerpolicy&&(n.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?n.credentials="include":r.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const O="https://energyflow.b.goit.study/api/";var x,i,m;class _{constructor(t){R(this,i);R(this,x,"");D(this,x,t)}async objectGetRequest(t){return d(this,i,m).call(this,t)}async objectCreateRequest(t,s){return d(this,i,m).call(this,t,{method:"POST",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectDeleteRequest(t,s){return d(this,i,m).call(this,`${t}/${s}`,{method:"DELETE"})}async objectUpdateRequest(t,s){return d(this,i,m).call(this,`${t}/${s.id}`,{method:"PUT",body:JSON.stringify(s),headers:{"Content-Type":"application/json"}})}async objectPatchRequest(t,s){const{id:a,...r}=s;return d(this,i,m).call(this,`${t}/${a}/rating`,{method:"PATCH",body:JSON.stringify(r),headers:{"Content-Type":"application/json"}})}}x=new WeakMap,i=new WeakSet,m=async function(t,s={}){try{const a=await fetch(B(this,x)+t,s);if(!a.ok)throw new Error(`HTTP error, status: ${a.status}`);return a.json()}catch(a){throw a}};const ce=document.querySelector(".js-quote"),F="quote",j="date",ie=new _(O);le();async function le(){try{const{quote:e,author:t}=await ue();me({quote:e,author:t})}catch(e){console.error("Error fetching or displaying quote:",e)}}async function ue(){const e=localStorage.getItem(j),t=localStorage.getItem(F),a=new Date().toISOString().split("T")[0];if(e===a&&t){const n=JSON.parse(t);if(n.quote&&n.author)return n}const r=await de();return localStorage.setItem(j,a),localStorage.setItem(F,JSON.stringify(r)),r}async function de(){const{quote:e,author:t}=await ie.objectGetRequest("quote");return{quote:e,author:t}}function me({quote:e,author:t}){ce.innerHTML=`
    <p class="quote-text">${e}</p>
    <h3 class="quote-author">${t}</h3>
  `}const o="/js_96_VPresich/assets/symbols-4ad092cf.svg";function nt(e=[],t){return e.reduce((s,{_id:a,bodyPart:r,equipment:n,time:c,target:p,burnedCalories:f,gifUrl:L,name:g,filter:M,popularity:N,rating:oe})=>s+`
  ...
  >
    ...
    >
      ...
      `}const W=(e,t)=>{const s=Be(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",s)};async function De(e){const t=new _(O);try{return await t.objectPatchRequest($e,e)}catch(s){throw s}}const Fe="/js_96_VPresich/assets/bi-x-octagon-73f29380.svg",je="/js_96_VPresich/assets/bi_check-45de7d45.svg";function b(e){H.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#fc5a5a",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${Fe}`,iconColor:"#fafafb"})}function Pe(e){H.show({message:e,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#82C43C",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${je}`,iconColor:"#fafafb"})}let k,$,E,S,q,u=0,v,Z=document.querySelector("."+J);function Ue(e,t){e.preventDefault(),t&&(q=t,Ne({exerciseRating:u},Z),k=document.querySelector(ke),W({exerciseRating:u},k),Ge())}function Ge(){$=document.querySelector(we),$&&$.addEventListener("click",Ye),E=document.querySelector(_e),E&&E.addEventListener("input",Je),S=document.querySelector(qe),S&&S.addEventListener("input",Ke);const e=document.querySelector(Ae);e&&e.addEventListener("click",ee),X()}function He(e){u=e.getAttribute("data-starnumber"),W({exerciseRating:u},k),X()}function X(){const e=document.querySelectorAll(Oe);e&&e.forEach(function(t){t.addEventListener("click",()=>{He(t)})})}function Je(e){E.textContent=e.target.value,v=e.target.value}function Ke(e){S.textContent=e.target.value,e.target.value}function Ye(e){if(e.preventDefault(),!u){b("Please select a rating");return}if(!v){b("Please enter a email");return}if(!Ie(v)){b("please enter a valid email address");return}let t={id:q,rate:Number(u),email:v};De(t).then(s=>{Pe("Success"),te(),ee()}).catch(s=>{b("err: ",s.message)})}function ee(e){te(),z(q).then(t=>{V(t,Z),se()}).catch(t=>{b("err: ",t.message)})}function te(){u=0,v=""}let w,h,A,l,y=document.querySelector("."+J);y&&y.addEventListener("click",Ve);const P=document.querySelector(be);P&&P.addEventListener("click",Qe);async function Qe(e){e.preventDefault();const t=e.target;if(t.classList.contains(he)&&(t.nodeName!=="BUTTON"?l=t.closest("button").dataset.id:l=t.dataset.id,!!l))try{const s=await z(l);s&&(V(s,y),se())}catch(s){console.log(s.message)}}function I(e){window.removeEventListener("keydown",ae),y.classList.remove(K)}function se(){y.classList.add(K),window.addEventListener("keydown",ae),w=document.querySelector(ge),w&&w.addEventListener("click",I),h=document.querySelector(ve),h&&h.addEventListener("click",ze),Se(l,h);const e=document.querySelector(xe);Re(e),A=document.querySelector(ye),A&&A.addEventListener("click",We)}function ae(e){e.code===fe&&I()}function Ve(e){e.currentTarget===e.target&&I()}function ze(e){Le(l,h)}function We(e){Ue(e,l)}const U=[{url:"https://www.facebook.com/goITclub/",id:"#facebook",label:"facebook icon",hrefTag:"icon-facebook"},{url:"https://www.instagram.com/goitclub/",id:"#instagram",label:"instagram icon",hrefTag:"icon-instagram"},{url:"https://www.youtube.com/c/GoIT",id:"#youtube",label:"youtube icon",hrefTag:"icon-youtube"}];function Ze(e,t=[]){const{iconURL:s,iconContainerClass:a,iconLinkClass:r,iconClass:n}=e;return t.reduce((c,{url:p,id:f,label:L,hrefTag:g})=>c+`
        <li class="${a}">
            <a class="${r}" target="_blank" rel="noopener" href="${p}">
            <svg class="${n}" aria-label="${L}" id=${f}>
                <use href="${s}#${g}"></use>
            </svg>
            </a>
        </li>
      `,"")}function G(e,t,s=[]){const a=Ze(t,s);e.innerHTML="",e.insertAdjacentHTML("beforeend",a)}const ot=()=>{const e={iconURL:o,iconContainerClass:"social-list-item",iconLinkClass:"social-list-link",iconClass:"social-list-icon"},t=document.querySelector(".social-list-header");G(t,e,U);const s={iconURL:o,iconContainerClass:"social-list-item",iconLinkClass:"social-list-link-menu",iconClass:"social-list-icon-menu"},a=document.querySelector(".social-list-menu");G(a,s,U)},Xe=document.querySelector(".js-open-menu-btn"),re=document.querySelector(".js-mobile-menu"),et=document.querySelector(".js-mobile-menu-close-btn"),ne="is-open";Xe.addEventListener("click",()=>{re.classList.add(ne)});et.addEventListener("click",()=>{re.classList.remove(ne)});function tt(e){e.classList.add("active-btn"),e.classList.remove("btn")}function st(e){e.classList.remove("active-btn"),e.classList.add("btn")}function ct(e,t){Array.from(e).forEach(s=>{tt(s)}),Array.from(t).forEach(s=>{st(s)})}export{O as B,_ as D,pe as K,ot as a,Pe as b,b as c,G as d,nt as e,o as i,ct as m,Qe as o,U as s,Ie as v};
//# sourceMappingURL=handle-menu-buttons-a8c3c6e9.js.map
